        ...
        return JSON.stringify({
            items: [
                ...
                },
                {
                    ...
                    content: "A lightweight utility library providing common helper functions for TypeScript projects, including string manipulation, array utilities, and validation helpers.",
                    evidence: [
                        {
                            sourceType: "config",
                            filePath: "package.json",
                ...
                {
                    category: "usage",
                    content: 'Import the module: `import { greet, formatDate, validateEmail } from "sample-lib"`. Call `greet("World")` to get a greeting string.',
                    evidence: [
                        {
                            sourceType: "export",
                ...
                },
                {
                    ...
                    content: "Exported functions: `greet(name: string): string`, `formatDate(date: Date): string`, `validateEmail(email: string): boolean`",
                    evidence: [
                        {
                            sourceType: "export",
                            filePath: "src/index.ts",
...
export function createProvider(config) {
    ...
    if (!apiKey) {
        throw new Error("未找到 API Key。请设置环境变量 OPENAI_API_KEY，或使用 --provider mock 进行测试。");
    }
